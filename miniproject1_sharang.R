...
data$qualitycat[data$quality <6] = "BAD"
...
varImportance_rf_model = data.frame(importance_rf_model)
varImportance_rf_model$variable= row.names(varImportance_rf_model)                            
